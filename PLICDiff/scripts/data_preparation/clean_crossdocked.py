...
TYPES_FILENAME = 'types/it2_tt_v1.3_completeset_train0.types'  

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--source', type=str, default='./data/CrossDocked2020')
    parser.add_argument('--dest', type=str, required=True) # destination directory
    parser.add_argument('--rmsd_thr', type=float, default=1.0)  # rmsd threshold for filtering out bad pairs
