...
class PLIC:
    ...
    def pli_processor(self, ligand_fn, pocket_fn):
        try:
            ...
            complex_mol, complex_fn, fd = self._join_complex(ligand_fn, pocket_fn)   
...
if __name__ == "__main__":
    import argparse
    from pl_pair_dataset_mp import PocketLigandPairDataset
    ...
    parser.add_argument('--raw_path', type=str,default='./data/crossdocked_v1.3_rmsd1.0_pocket10')
    parser.add_argument('--split_data_path', type=str,default='./data/crossdocked_pocket10_pose_split.pt')
    parser.add_argument('--base_path', type=str,default='./data/crossdocked_v1.3_rmsd1.0_pocket10')
